...
const I18N = {
  ko: {
    ...
    presets:'프리셋', preset_load:'불러오기', preset_save:'현재 설정 저장',
    preset_name_prompt:'��리셋 이름을 입력하세요', preset_saved:'프리셋이 저장되었습니다',
    preset_save_failed:'저장 실패', preset_loaded:'프리셋 적용',
    preset_deleted:'프리셋이 삭제되었습니���', preset_delete_failed:'삭제 실패',
    preset_delete_confirm:'이 프리셋을 삭제하시겠습���까?',
    preset_empty_warn:'저장할 설정이 없습니다', preset_none:'저장된 프리셋이 없습니다',
  },
  en: {
    ...
    presets:'Presets', preset_load:'Load', preset_save:'Save current',
    preset_name_prompt:'Enter preset name', preset_saved:'Preset saved',
    preset_save_failed:'Save failed', preset_loaded:'Preset applied',
    preset_deleted:'Preset deleted', preset_delete_failed:'Delete failed',
    preset_delete_confirm:'Delete this preset?',
    preset_empty_warn:'Nothing to save', preset_none:'No saved presets',
  },
  ja: {
